...
public class _02_HexadecimalPrinter implements ActionListener {
	...
	/*
	 * int num = binaryToDec(binaryStr); String hex = ""; while (num != 0) { if (num
	 * >= 15) { num -= 15; hex += "F"; } else { switch (num) { case 14: num -= 14;
	 * hex += "E"; break; case 13: num -= 13; hex += "D"; break; case 12: num -= 12;
	 * hex += "C"; break; case 11: num -= 11; hex += "B"; break; case 10: num -= 10;
	 * hex += "A"; break; default: hex += num; num -= num; } } }
	 */
	...
	String hexConversion (StringBuilder s) {
    	s.reverse();
    	String hex = "";
